...
public class SchoolController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case "logout.do":
			...
			break;
		case "schoolpage.do":
			viewSchoolPage(request, response);
			break;
		case "schoolprofile.do":
			viewSchoolProfile(request, response);
			break;
		case "findschoolinfo.do":
			findSchoolInfo(request, response);
			break;
		case "findschoolid.do":
			findSchoolIdImpl(request, response);
			break;
		case "findschoolpw.do":
			findSchoolPwImpl(request, response);
			break;
		case "modifyinfo.do":
			modifySchoolInfo(request, response);
			break;
		case "modifyservice.do":
			modifySchoolService(request, response);
			break;
		case "modifyphoto.do":
			modifySchoolPhoto(request, response);
			break;
		}
	...
	protected void loginImpl(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void viewSchoolProfile(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void findSchoolInfo(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void findSchoolPwImpl(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {

	}

	protected void modifySchoolInfo(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void modifySchoolService(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void modifySchoolPhoto(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
